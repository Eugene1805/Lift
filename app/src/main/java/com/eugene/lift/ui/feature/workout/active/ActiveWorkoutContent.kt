...
private class ExerciseEventDispatcher(
    ...
    fun onRpeChange(setIdx: Int, value: Double?) = onEvent(ActiveWorkoutUiEvent.RpeChanged(exIndex, setIdx, value))
    fun onRirChange(setIdx: Int, value: Int?) = onEvent(ActiveWorkoutUiEvent.RirChanged(exIndex, setIdx, value))
