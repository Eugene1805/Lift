...
object ExerciseImageMapper {
    ...
    private val seedKeyToDrawable: Map<String, String> = mapOf(
        ...
        "seed_dumbbell_shoulder_press" to "standing_dumbbell_shoulder_press",
    ...
    private val nameToDrawable: Map<String, String> = mapOf(
        ...
        "dumbbell shoulder press"                    to "standing_dumbbell_shoulder_press",
        "press de hombros con mancuernas"            to "standing_dumbbell_shoulder_press",
