 ...
 * update processes.
 */
private fun imageFor(context: Context, @StringRes nameRes: Int): String? {
    val resourceEntryName = context.resources.getResourceEntryName(nameRes)
    return ExerciseImageMapper.getDrawableForSeedKey(resourceEntryName)
}
    ...
    private fun buildBootstrapExercises(context: Context): List<Exercise> {
        return SeedExerciseStrings.attachSeedKeys(context, listOf(
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_bench_press),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_squat),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_deadlift),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_overhead_press),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_barbell_row),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_dumbbell_press),
                bodyParts = listOf(BodyPart.CHEST, BodyPart.TRICEPS, BodyPart.FRONT_DELTS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_dumbbell_shoulder_press),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_lat_pulldown),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_leg_press),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_pullup),
                bodyParts = listOf(BodyPart.LATS, BodyPart.BICEPS, BodyPart.REAR_DELTS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_pushup),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_plank),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_dumbbell_row),
                bodyParts = listOf(BodyPart.LATS, BodyPart.TRAPS, BodyPart.BICEPS, BodyPart.REAR_DELTS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_bicep_curl),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_tricep_extension),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_lateral_raise),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_romanian_deadlift),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_front_squat),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_leg_curl),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_leg_extension),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_face_pull),
                bodyParts = listOf(BodyPart.REAR_DELTS, BodyPart.TRAPS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                name = context.getString(R.string.seed_machine_lateral_raise),
                category = ExerciseCategory.MACHINE,
                measureType = MeasureType.REPS_AND_WEIGHT,
                instructions = context.getString(R.string.seed_machine_lateral_raise_desc),
                imagePath = imageFor(context, R.string.seed_machine_lateral_raise),
                bodyParts = listOf(BodyPart.SIDE_DELTS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_dips),
                bodyParts = listOf(BodyPart.CHEST, BodyPart.TRICEPS, BodyPart.FRONT_DELTS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_hip_thrust),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_incline_bench),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_calf_raise),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_skull_crusher),
                bodyParts = listOf(BodyPart.TRICEPS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_cable_tricep_pushdown),
                bodyParts = listOf(BodyPart.TRICEPS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_hammer_curl),
                bodyParts = listOf(BodyPart.BICEPS, BodyPart.FOREARMS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                name = context.getString(R.string.seed_reverse_curl),
                category = ExerciseCategory.BARBELL,
                measureType = MeasureType.REPS_AND_WEIGHT,
                instructions = context.getString(R.string.seed_reverse_curl_desc),
                imagePath = imageFor(context, R.string.seed_reverse_curl),
                bodyParts = listOf(BodyPart.BICEPS, BodyPart.FOREARMS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_bulgarian_split_squat),
                bodyParts = listOf(BodyPart.QUADRICEPS, BodyPart.GLUTES, BodyPart.HAMSTRINGS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
            ...
            Exercise(
                id = UUID.randomUUID().toString(),
                name = context.getString(R.string.seed_step_up),
                category = ExerciseCategory.DUMBBELL,
                measureType = MeasureType.REPS_AND_WEIGHT,
                instructions = context.getString(R.string.seed_step_up_desc),
                imagePath = imageFor(context, R.string.seed_step_up),
                bodyParts = listOf(BodyPart.QUADRICEPS, BodyPart.GLUTES, BodyPart.HAMSTRINGS, BodyPart.CORE)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_chest_supported_row),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_hanging_leg_raise),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_russian_twist),
                bodyParts = listOf(BodyPart.CORE)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_reverse_pec_deck),
                bodyParts = listOf(BodyPart.REAR_DELTS, BodyPart.TRAPS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_cable_lateral_raise),
                bodyParts = listOf(BodyPart.SIDE_DELTS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_pec_deck),
                bodyParts = listOf(BodyPart.CHEST, BodyPart.FRONT_DELTS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_seated_cable_row),
                bodyParts = listOf(BodyPart.LATS, BodyPart.TRAPS, BodyPart.BICEPS, BodyPart.REAR_DELTS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_machine_shoulder_press),
                bodyParts = listOf(BodyPart.FRONT_DELTS, BodyPart.SIDE_DELTS, BodyPart.TRICEPS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_glute_bridge),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_bicycle_crunch),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_preacher_curl),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_weighted_pullup),
                bodyParts = listOf(BodyPart.LATS, BodyPart.BICEPS, BodyPart.REAR_DELTS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_weighted_dip),
                bodyParts = listOf(BodyPart.CHEST, BodyPart.TRICEPS, BodyPart.FRONT_DELTS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_arnold_press),
                bodyParts = listOf(BodyPart.FRONT_DELTS, BodyPart.SIDE_DELTS, BodyPart.TRICEPS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_goblet_squat),
                bodyParts = listOf(BodyPart.QUADRICEPS, BodyPart.GLUTES, BodyPart.CORE)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_farmers_walk),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_box_jump),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_cable_row),
                bodyParts = listOf(BodyPart.LATS, BodyPart.TRAPS, BodyPart.REAR_DELTS, BodyPart.BICEPS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_machine_row),
                bodyParts = listOf(BodyPart.LATS, BodyPart.TRAPS, BodyPart.REAR_DELTS, BodyPart.BICEPS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_incline_dumbbell_press),
                bodyParts = listOf(BodyPart.CHEST, BodyPart.FRONT_DELTS, BodyPart.TRICEPS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_cable_crossover),
                bodyParts = listOf(BodyPart.CHEST, BodyPart.FRONT_DELTS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_ez_bar_curl),
                bodyParts = listOf(BodyPart.BICEPS, BodyPart.FOREARMS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_cable_curl),
                bodyParts = listOf(BodyPart.BICEPS, BodyPart.FOREARMS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_dumbbell_overhead_press),
                bodyParts = listOf(BodyPart.FRONT_DELTS, BodyPart.SIDE_DELTS, BodyPart.TRICEPS, BodyPart.CORE)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_barbell_shrug),
                bodyParts = listOf(BodyPart.TRAPS, BodyPart.NECK)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_t_bar_row),
                bodyParts = listOf(BodyPart.LATS, BodyPart.TRAPS, BodyPart.REAR_DELTS, BodyPart.BICEPS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_back_extension),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_single_leg_deadlift),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_chin_up),
                bodyParts = listOf(BodyPart.LATS, BodyPart.BICEPS, BodyPart.REAR_DELTS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_hip_adduction),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_hip_abduction),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_ab_wheel),
                bodyParts = listOf(BodyPart.CORE)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_weighted_crunch),
                bodyParts = listOf(BodyPart.CORE)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context,R.string.seed_rope_tricep_extension),
                bodyParts = listOf(BodyPart.TRICEPS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_rope_face_pull),
                bodyParts = listOf(BodyPart.REAR_DELTS, BodyPart.TRAPS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_sumo_deadlift),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_decline_dumbbell_press),
                bodyParts = listOf(BodyPart.CHEST, BodyPart.TRICEPS, BodyPart.FRONT_DELTS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_glute_kickback),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_wrist_curl),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_reverse_wrist_curl),
                bodyParts = listOf(BodyPart.FOREARMS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_chest_press_machine),
                bodyParts = listOf(BodyPart.CHEST, BodyPart.TRICEPS, BodyPart.FRONT_DELTS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_upright_row),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_cable_oblique_twist),
                bodyParts = listOf(BodyPart.CORE)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_power_clean),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_hack_squat),
                bodyParts = listOf(BodyPart.QUADRICEPS, BodyPart.GLUTES, BodyPart.HAMSTRINGS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_smith_machine_squat),
                bodyParts = listOf(BodyPart.QUADRICEPS, BodyPart.GLUTES, BodyPart.HAMSTRINGS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_seated_leg_curl),
                bodyParts = listOf(BodyPart.HAMSTRINGS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_smith_machine_bench),
                bodyParts = listOf(BodyPart.CHEST, BodyPart.TRICEPS, BodyPart.FRONT_DELTS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_smith_machine_shoulder_press),
                bodyParts = listOf(BodyPart.FRONT_DELTS, BodyPart.SIDE_DELTS, BodyPart.TRICEPS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_dragon_flag),
                bodyParts = listOf(BodyPart.CORE)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_muscle_up),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_front_lever),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_smith_machine_bulgarian_split_squat),
                bodyParts = listOf(BodyPart.QUADRICEPS, BodyPart.GLUTES, BodyPart.HAMSTRINGS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_smith_machine_incline_bench),
                bodyParts = listOf(BodyPart.CHEST, BodyPart.FRONT_DELTS, BodyPart.TRICEPS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_machine_fly),
                bodyParts = listOf(BodyPart.CHEST, BodyPart.FRONT_DELTS)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_machine_pullover),
                bodyParts = listOf(BodyPart.LATS, BodyPart.CHEST)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_cable_pullover_bar),
                bodyParts = listOf(BodyPart.LATS, BodyPart.CHEST)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                name = context.getString(R.string.seed_smith_machine_hip_thrust),
                category = ExerciseCategory.MACHINE,
                measureType = MeasureType.REPS_AND_WEIGHT,
                instructions = context.getString(R.string.seed_smith_machine_hip_thrust_desc),
                imagePath = imageFor(context, R.string.seed_smith_machine_hip_thrust),
                bodyParts = listOf(BodyPart.GLUTES, BodyPart.HAMSTRINGS, BodyPart.CORE)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                name = context.getString(R.string.seed_smith_machine_romanian_deadlift),
                category = ExerciseCategory.MACHINE,
                measureType = MeasureType.REPS_AND_WEIGHT,
                instructions = context.getString(R.string.seed_smith_machine_romanian_deadlift_desc),
                imagePath = imageFor(context, R.string.seed_smith_machine_romanian_deadlift),
                bodyParts = listOf(BodyPart.HAMSTRINGS, BodyPart.GLUTES, BodyPart.LOWER_BACK)
            ),
            ...
            Exercise(
                ...
                imagePath = imageFor(context, R.string.seed_cable_overhead_triceps_extension),
                bodyParts = listOf(BodyPart.TRICEPS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_cable_overhead_triceps_extension_unilateral),
                bodyParts = listOf(BodyPart.TRICEPS)
            ),
            Exercise(
                id = UUID.randomUUID().toString(),
                ...
                imagePath = imageFor(context, R.string.seed_cable_overhead_triceps_extension_cuff),
                bodyParts = listOf(BodyPart.TRICEPS)
            ),
            ...
            Exercise(
                id = UUID.randomUUID().toString(),
                name = context.getString(R.string.seed_single_arm_triceps_extension),
                category = ExerciseCategory.MACHINE,
                measureType = MeasureType.REPS_AND_WEIGHT,
                instructions = context.getString(R.string.seed_single_arm_triceps_extension_desc),
                imagePath = imageFor(context, R.string.seed_single_arm_triceps_extension),
                bodyParts = listOf(BodyPart.TRICEPS)
            )
        ))
    }
